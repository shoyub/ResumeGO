      ...
      <div className="p-5 shadow-lg rounded-lg border-t-4 border-black mt-10 bg-white">
        ...
        <div>
          {skillsList.map((item, index) => (
            <div
              key={index}
              className="flex justify-between border border-gray-200 rounded-lg p-3 mt-3 bg-white"
            >
              <div className="w-full mr-4">
                <label className="text-xs text-gray-700">Name</label>
                <Input
                  value={item.name}
                  className="w-full mt-1 border-gray-300 text-gray-900 placeholder-gray-400"
