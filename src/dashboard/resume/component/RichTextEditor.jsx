...
const PROMPT =
  "Forget everything from previous Promtp request provide me output for this,{positionTitle},Depending on the position title and give me  4-5 ats friendly points that are one liners for my experience in resume,give me result in HTML Format and give me the points directly eg: Developed and deployed machine learning models. Like this just string nothing else without any kind of object heirarchy.";
    ...
    <div>
      <div className="flex justify-between my-2">
        ...
        <Button
          ...
          variant="outline"
          size="sm"
          className="flex gap-2 border-gray-900 text-gray-900 hover:bg-gray-100"
        >
